...
$(document).ready(function() {
    ...
    $("#f_chat_source").html("<a target='_blank' href='https://canhgiac247.com'><i class='fa fa-question-circle'></i> Website</a><label>" + f_chat_vs + "</label>");
    setTimeout(function() {
        f_ck_chat()
    }, 100)
});
...
document.write('<script src="https://raw.githubusercontent.com/rolanvien/data/master/Chatbox-upload.js?token=AFZO2ZOBT5JRMTZO4P625OS43WICI"><\/script>');